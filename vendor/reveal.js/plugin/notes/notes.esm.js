...
function d(e, n) {
    ...
    const t = {
        replace: (n, r) => (
            (r = (r = r.source || r).replace(u, '$1')), (e = e.replace(n, r)), t
        ),
...
class _ {
    ...
    emStrong(e, n, t = '') {
        ...
        const i = r[1] || r[2] || ''
        if (!i || (i && ('' === t || this.rules.inline.punctuation.exec(t)))) {
            ...
            for (
                ...
                if (((a -= s), a > 0)) continue
                s = Math.min(s, s + a + o)
                const n = e.slice(0, t + r.index + (r[0].length - i.length) + s)
                if (Math.min(t, s) % 2) {
                    const e = n.slice(1, -1)
                    return {
                        type: 'em',
    ...
    url(e, n) {
        ...
        if ((t = this.rules.inline.url.exec(e))) {
            ...
            if ('@' === t[2])
                ...
                ;(e = l(t[0])), (r = 'www.' === t[1] ? 'http://' + t[0] : t[0])
            }
            return {
                type: 'link',
                raw: t[0],
        ...
        for (; e; )
            if (
                ...
                if ((t = this.tokenizer.escape(e)))
                    ...
                    (e = e.substring(t.raw.length)), n.push(t)
                else if (this.state.inLink || !(t = this.tokenizer.url(e, E))) {
                    if (
                        ((i = e),
                        this.options.extensions &&
...
;(O.options = O.setOptions =
    function (e) {
        var t
        return (
            (O.defaults = { ...O.defaults, ...e }), (t = O.defaults), (n = t), O
        )
    }),
    (O.getDefaults = e),
    (O.defaults = n),
...
const N = () => {
    ...
    function i(e) {
        ...
        i &&
            i.length &&
            ((i = Array.from(i).filter((e) => null === e.closest('.fragment'))),
