!(function (e, t) {
    ...
    class S {
            ...
            if (t) {
                ...
                for (l = 0; l < m; l++)
                    if (
                        ...
                        (k.items[l].tokens = this.lexer.blockTokens(
                            k.items[l].text,
                            []
                        )),
                        !k.loose)
                    ) {
                        const e = k.items[l].tokens.filter(
                                (e) => 'space' === e.type
                            ),
                            t =
                                e.length > 0 &&
            ...
            if (t) {
                ...
                if (e.header.length === e.align.length) {
                    ...
                    for (l = e.rows.length, n = 0; n < l; n++)
                        e.rows[n] = y(e.rows[n], e.header.length).map((e) => ({
                            text: e,
                        }))
        ...
        emStrong(e, t, n = '') {
            ...
            if (
                ...
                for (
                    ...
                    const t = e.slice(
                        0,
                        n + s.index + (s[0].length - r.length) + i
                    )
                    if (Math.min(n, i) % 2) {
                        const e = t.slice(1, -1)
                        return {
        ...
        url(e, t) {
            ...
            if ((n = this.rules.inline.url.exec(e))) {
                let e, s
                if ('@' === n[2])
                    (e = a(this.options.mangle ? t(n[0]) : n[0])),
                        (s = 'mailto:' + e)
                else {
                    let t
                    do {
    ...
    class v {
        ...
        inlineTokens(e, t = []) {
            ...
            for (
                ;
                null != (i = this.tokenizer.rules.inline.escapedEmSt.exec(a));
    ...
    class I {
        ...
        link(e, t, n) {
            if (
                null === (e = f(this.options.sanitize, this.options.baseUrl, e))
            )
                return n
            let s = '<a href="' + e + '"'
        ...
        return (n, s, r) => {
            ...
            if (s.async)
                return Promise.resolve(s.hooks ? s.hooks.preprocess(n) : n)
                    ...
                    .then((e) =>
                        s.walkTokens
                            ? Promise.all(P.walkTokens(e, s.walkTokens)).then(
                                  () => e
                              )
                            : e
                    )
                ...
                switch (((n = n.concat(t.call(P, s))), s.type)) {
                    case 'table':
                        for (const e of s.header)
                            n = n.concat(P.walkTokens(e.tokens, t))
                    ...
                    default:
                        ...
                        P.defaults.extensions.childTokens[s.type]
                            ? P.defaults.extensions.childTokens[s.type].forEach(
                                  function (e) {
                ...
                p[e] instanceof Array
                    ? ((u += '<section ' + t.attributes + '>'),
                      p[e].forEach(function (e) {
                          u +=
                              '<section data-markdown>' + r(e, t) + '</section>'
                      }),
                      (u += '</section>'))
                    : (u +=
                          '<section ' +
