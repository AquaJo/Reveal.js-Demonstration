        ...
        ;(this.pages = o.map((i) => {
            ...
            for (let e = 0; e < o + 1; e++) {
                ...
                ;(t.className = 'scroll-snap-point'),
                    ...
                    0 === e &&
                        (t.style.marginTop = -this.scrollTriggerHeight + 'px')
            }
            return (
            ...
            if (!1 === i.classList.contains('stack')) {
                ...
                if (e.pdfSeparateFragments) {
                    ...
                    e.forEach(function (e, i) {
                        ...
                        if (s) {
                            const e = i + 1
                            a.querySelector('.slide-number-pdf').innerHTML +=
                                '.' + e
                        }
                        g.push(a), (t = e)
                    }, this),
    ...
    onDocumentKeyDown(e) {
        ...
        let a =
            ...
            l =
                !(
                    (-1 !==
                        [32, 37, 38, 39, 40, 78, 80, 191].indexOf(e.keyCode) &&
                        e.shiftKey) ||
                    e.altKey
                ) &&
...
function $(n, o) {
    ...
    function we(t) {
        ...
        X.wrapper.classList.remove(s.transition),
            ...
            X.wrapper.setAttribute('data-transition-speed', A.transitionSpeed),
    ...
    function Le({ target: t = X.wrapper, type: i, data: s, bubbles: a = !0 }) {
    ...
    function je() {
        const e = X.wrapper.classList.contains('paused')
        X.wrapper.classList.remove('paused'), ut(), e && Le({ type: 'resumed' })
    }
    function Ke(e) {
    ...
    function Xe(e, i, s, a) {
        ...
        let o = c || 0,
            l = h || 0
        ;(c = Ge(f, void 0 === e ? c : e)), (h = Ge(y, void 0 === i ? h : i))
        let d = c !== o || h !== l
        d || (g = null)
        let u = n[c],
        ...
        d && Ce(a),
            (!d && g) || (Z.stopEmbeddedContent(g), Z.startEmbeddedContent(p)),
            requestAnimationFrame(() => {
                ye(be(p))
            }),
            he.update(),
        ...
        if (e)
            if (ae.isActive())
                ...
                ;(s = Math.max(r.indexOf(n), 0)),
                    (a = void 0),
                    i &&
                        (a = Math.max(t(e.parentNode, 'section').indexOf(e), 0))
            }
        if (!e && p) {
    ...
    function mt({ skipFragments: e = !1 } = {}) {
        if (((D.hasNavigatedHorizontally = !0), ae.isActive())) return ae.prev()
        A.rtl
    ...
    function ft({ skipFragments: e = !1 } = {}) {
        if (((D.hasNavigatedHorizontally = !0), ae.isActive())) return ae.next()
        A.rtl
            ? (oe.isActive() || e || !1 === re.prev()) &&
              tt().right &&
              Xe(c - 1, 'grid' === A.navigationMode ? h : void 0)
    ...
    function bt({ skipFragments: e = !1 } = {}) {
        if (((D.hasNavigatedVertically = !0), ae.isActive())) return ae.next()
        ;(oe.isActive() || e || !1 === re.next()) && tt().down && Xe(c, h + 1)
    }
