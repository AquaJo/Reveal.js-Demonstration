...
!(function (e, t) {
    ...
    var p = (function (e) {
        if (e) {
            var t = function (e) {
                ...
                S = function () {
                    e.clearTimeout(E),
                        (E = e.setTimeout(r(2), k.observeWindowDelay))
                },
            ...
            if (i) {
                ...
                if (e && 0 !== e.a)
                    return (
                        ...
                        (s ? (299 * s.r + 587 * s.g + 114 * s.b) / 1e3 : null) <
                        128
                            ? 'has-dark-background'
    ...
    class C {
        ...
        activate() {
            ...
            i.forEach((e, t) => {
                ...
                t(this.Reveal.getRevealElement(), '.stack').forEach((e) =>
                    e.remove()
                ),
        ...
        createProgressBar() {
            ...
            const e = (e) => {
                    let t =
                        (e.clientY -
                            this.progressBarInner.getBoundingClientRect().top) /
        ...
        setTriggerRanges() {
            ...
            this.slideTriggers.forEach((t, i) => {
                ...
                const s =
                    (t.range[1] - t.range[0]) / t.page.scrollTriggers.length
                ...
                this.slideTriggers.push(
                    ...Array.from(e.autoAnimateElements).map((t, i) => {
                        let s = this.createPage({
                            ...
                            contentElement: t,
                            backgroundElement:
                                t.querySelector('.slide-background'),
                        })
                        return (
                ...
                s > 6
                    ? this.slideTriggers.forEach((e) => {
                          ...
                          ;(t.progressBarSlide = document.createElement('div')),
                              ...
                              (t.scrollTriggerElements = t.scrollTriggers.map(
                                  (i, s) => {
        ...
        syncScrollPosition() {
            const e = this.viewportElement.offsetHeight,
                ...
                n = Math.max(
                    Math.min(
                        (i + e / 2) / this.viewportElement.scrollHeight,
                        1
                    ),
                    0
                )
            ...
            this.slideTriggers.forEach((e) => {
                ...
                a >= e.range[0] - 2 * t && a <= e.range[1] + 2 * t && !i.loaded
                    ? ((i.loaded = !0),
                      this.Reveal.slideContent.load(i.slideElement))
                    : i.loaded &&
                      ((i.loaded = !1),
                      this.Reveal.slideContent.unload(i.slideElement)),
                ...
                this.setProgressBarValue(
                    i / (this.viewportElement.scrollHeight - e)
                )
        }
        ...
        onDocumentKeyDown(e) {
            ...
            let a =
                ...
                l =
                    !(
                        (-1 !==
                            [32, 37, 38, 39, 40, 78, 80, 191].indexOf(
                                e.keyCode
                            ) &&
                            e.shiftKey) ||
                        e.altKey
    ...
    function $(n, o) {
        ...
        function fe() {
            ;(k = !0),
                A.showHiddenSlides ||
                    t(X.wrapper, 'section[data-visibility="hidden"]').forEach(
                        (e) => {
                            const t = e.parentNode
                            1 === t.childElementCount &&
                            /section/i.test(t.nodeName)
                                ? t.remove()
                                : e.remove()
                        }
                    ),
                ...
                A.postMessage && window.addEventListener('message', St, !1),
                setInterval(() => {
                    ;((!ae.isActive() && 0 !== X.wrapper.scrollTop) ||
                        0 !== X.wrapper.scrollLeft) &&
                ...
                (function () {
                    ...
                    ;(e || t) &&
                        (e ? Se() : ve.unbind(),
                        X.viewport.classList.add('loading-scroll-mode'),
                        e
        ...
        function we(t) {
            ...
            const a = X.wrapper.querySelectorAll(m).length
            X.wrapper.classList.remove(s.transition),
                X.wrapper.classList.add(A.transition),
                ...
                A.shuffle && Je(),
                i(X.wrapper, 'embedded', A.embedded),
                i(X.wrapper, 'rtl', A.rtl),
                i(X.wrapper, 'center', A.center),
                !1 === A.pause && je(),
                A.previewLinks
                    ? (Pe(), Te('[data-preview-link=false]'))
                    : (Te(),
                      Pe('[data-preview-link]:not([data-preview-link=false])')),
                ie.reset(),
                w && (w.destroy(), (w = null)),
                a > 1 &&
                    A.autoSlide &&
                    ...
                    ((w = new V(X.wrapper, () =>
                        Math.min(Math.max((Date.now() - G) / _, 0), 1)
                    )),
                    w.on('click', Pt),
                    (Q = !1)),
        ...
        function Ee() {
            window.addEventListener('resize', kt, !1),
                ...
                A.keyboard && le.bind(),
                A.progress && he.bind(),
                A.respondToHashChanges && de.bind(),
                ce.bind(),
                pe.bind(),
                X.slides.addEventListener('click', Rt, !1),
                X.slides.addEventListener('transitionend', At, !1),
                X.pauseOverlay.addEventListener('click', je, !1),
                A.focusBodyOnPageVisibilityChange &&
                    document.addEventListener('visibilitychange', Lt, !1)
        }
        function Se() {
            ve.unbind(),
                pe.unbind(),
                ...
                X.slides.removeEventListener('click', Rt, !1),
                X.slides.removeEventListener('transitionend', At, !1),
        ...
        function ke(e) {
            'string' == typeof e.layout && ($.layout = e.layout),
                'string' == typeof e.overview && ($.overview = e.overview),
                $.layout
                    ? a(X.slides, $.layout + ' ' + $.overview)
                    : a(X.slides, $.overview)
        }
        function Le({
            target: t = X.wrapper,
        ...
        function xe(t, i) {
            if (A.postMessageEvents && window.parent !== window.self) {
                let s = { namespace: 'reveal', eventName: t, state: ht() }
        ...
        function Ie() {
            return (
                !!X.overlay &&
                (X.overlay.parentNode.removeChild(X.overlay),
                (X.overlay = null),
                !0)
            )
        }
            ...
            if (X.wrapper && !ne.isActive()) {
                ...
                if (!A.disableLayout) {
                    ...
                    const i = ae.isActive() ? De(e, t) : De(),
                        s = O
                    He(A.width, A.height),
                        (X.slides.style.width = i.width + 'px'),
                        (X.slides.style.height = i.height + 'px'),
                        (O = Math.min(
                            i.presentationWidth / i.width,
                            i.presentationHeight / i.height
                        )),
                        (O = Math.max(O, A.minScale)),
                        (O = Math.min(O, A.maxScale)),
                        1 === O || ae.isActive()
                            ? ((X.slides.style.zoom = ''),
                              (X.slides.style.left = ''),
                              (X.slides.style.top = ''),
                            ...
                            : ((X.slides.style.zoom = ''),
                              ...
                              ke({
                                  layout:
                                      'translate(-50%, -50%) scale(' + O + ')',
                              }))
                    const a = Array.from(X.wrapper.querySelectorAll(m))
                    ...
                    s !== O &&
                        Le({
                            type: 'resize',
                            data: { oldScale: s, scale: O, size: i },
                        })
                }
                !(function () {
                    if (
                        ...
                        e.presentationWidth <= A.scrollActivationWidth
                            ? ae.isActive() || (se.create(), ae.activate())
                            : ae.isActive() && ae.deactivate()
                    }
                })(),
                    X.viewport.style.setProperty('--slide-scale', O),
                    X.viewport.style.setProperty('--viewport-width', e + 'px'),
                    X.viewport.style.setProperty('--viewport-height', t + 'px'),
                    ae.layout(),
                    he.update(),
                    se.updateParallax(),
        ...
        function He(e, i) {
            t(X.slides, 'section > .stretch, section > .r-stretch').forEach(
                (t) => {
                    let s = ((e, t = 0) => {
                        if (e) {
                            let i,
        ...
        function De(e, t) {
            let i = A.width,
                s = A.height
            A.disableLayout &&
                ((i = X.slides.offsetWidth), (s = X.slides.offsetHeight))
            const a = {
                width: i,
                height: s,
            ...
            return (
                ...
                'string' == typeof a.width &&
                    /%$/.test(a.width) &&
                    (a.width =
                        (parseInt(a.width, 10) / 100) * a.presentationWidth),
                'string' == typeof a.height &&
                    /%$/.test(a.height) &&
                    (a.height =
                        (parseInt(a.height, 10) / 100) * a.presentationHeight),
                a
            )
        }
        function Fe(e, t) {
        ...
        function Oe() {
            return !(!p || !qe(p)) && !p.nextElementSibling
        }
        function We() {
            return 0 === c && 0 === h
        }
        function Ue() {
            return (
                ...
                (!qe(p) || !p.parentNode.nextElementSibling)
            )
        }
        function Ve() {
            if (A.pause) {
        ...
        function je() {
            const e = X.wrapper.classList.contains('paused')
            X.wrapper.classList.remove('paused'),
                ut(),
                e && Le({ type: 'resumed' })
        }
        function Ke(e) {
        ...
        function Xe(e, i, s, a) {
            ...
            d &&
                ...
                ((Y = 'running'),
                (m = Ye(g, p, o, l)),
                m && X.slides.classList.add('disable-slide-transitions')),
                et(),
                Be(),
                oe.isActive() && oe.update(),
                void 0 !== s && re.goto(s),
            ...
            e: for (let e = 0, t = q.length; e < t; e++) {
                ...
                X.viewport.classList.add(q[e]), Le({ type: q[e] })
            }
            for (; r.length; ) X.viewport.classList.remove(r.pop())
            d && Ce(a),
                (!d && g) ||
                    (Z.stopEmbeddedContent(g), Z.startEmbeddedContent(p)),
                requestAnimationFrame(() => {
                    ye(be(p))
                }),
                he.update(),
        ...
        function _e() {
            Se(),
                ...
                se.create(),
                de.writeURL(),
                !0 === A.sortFragmentsOnSync && re.sortAll(),
                ce.update(),
                he.update(),
                et(),
                me.update(),
                ...
                !1 === A.autoPlayMedia
                    ? Z.stopEmbeddedContent(p, { unloadIframes: !1 })
                    : Z.startEmbeddedContent(p),
        ...
        function Ge(e, i) {
            ...
            if (a) {
                ...
                e.classList.add('present'),
                    ...
                    t || Le({ target: e, type: 'visible', bubbles: !1 })
        ...
        function et() {
            let e,
                ...
                a = s.length
            if (a && void 0 !== c) {
                let n = oe.isActive() ? 10 : A.viewDistance
                u && (n = oe.isActive() ? 6 : A.mobileViewDistance),
                    ne.isActive() && (n = Number.MAX_VALUE)
                for (let r = 0; r < a; r++) {
                    let o = s[r],
                        l = t(o, 'section'),
                        d = l.length
        ...
        function tt({ includeFragments: e = !1 } = {}) {
            let t = X.wrapper.querySelectorAll(f),
                i = X.wrapper.querySelectorAll(y),
                s = {
                    left: c > 0,
                    right: c < t.length - 1,
                    up: h > 0,
            ...
            if ((gt(), p && !1 !== A.autoSlide)) {
                ...
                i
                    ...
                    !_ ||
                        ...
                        $e() ||
                        oe.isActive() ||
                        (Ue() && !re.availableRoutes().next && !0 !== A.loop) ||
                        ((J = setTimeout(() => {
        ...
        function pt() {
            _ &&
                !Q &&
                ((Q = !0),
                Le({ type: 'autoslidepaused' }),
                clearTimeout(J),
                w && w.setPlaying(!1))
        }
        function vt() {
            _ && Q && ((Q = !1), Le({ type: 'autoslideresumed' }), ut())
        }
        function mt({ skipFragments: e = !1 } = {}) {
            if (((D.hasNavigatedHorizontally = !0), ae.isActive()))
                return ae.prev()
            A.rtl
                ? (oe.isActive() || e || !1 === re.next()) &&
                  tt().left &&
                  Xe(c + 1, 'grid' === A.navigationMode ? h : void 0)
                : (oe.isActive() || e || !1 === re.prev()) &&
                  tt().left &&
                  Xe(c - 1, 'grid' === A.navigationMode ? h : void 0)
        }
        ...
        function yt({ skipFragments: e = !1 } = {}) {
            if (ae.isActive()) return ae.prev()
            ;(oe.isActive() || e || !1 === re.prev()) && tt().up && Xe(c, h - 1)
        }
        function bt({ skipFragments: e = !1 } = {}) {
            if (((D.hasNavigatedVertically = !0), ae.isActive()))
                return ae.next()
            ;(oe.isActive() || e || !1 === re.next()) &&
                tt().down &&
                Xe(c, h + 1)
        ...
        function wt({ skipFragments: e = !1 } = {}) {
            if (ae.isActive()) return ae.prev()
            if (e || !1 === re.prev())
                if (tt().up) yt({ skipFragments: e })
                else {
                    let i
                    if (
                        ((i = A.rtl
                            ? t(X.wrapper, f + '.future').pop()
                            : t(X.wrapper, f + '.past').pop()),
        ...
        function Et({ skipFragments: e = !1 } = {}) {
            ...
            if (e || !1 === re.next()) {
                let t = tt()
                t.down && t.right && A.loop && Oe() && (t.down = !1),
                    t.down
                        ? bt({ skipFragments: e })
                        : A.rtl
                          ? mt({ skipFragments: e })
        ...
        function St(e) {
            ...
            if (
                ...
                '}' === t.charAt(t.length - 1) &&
                ((t = JSON.parse(t)),
                t.method && 'function' == typeof l[t.method])
            )
                if (!1 === b.test(t.method)) {
                    const e = l[t.method].apply(l, t.args)
                    xe('callback', { method: t.method, result: e })
                } else
                    console.warn(
                        'reveal.js: "' +
                            t.method +
        ...
        function Ct(e) {
            ;(document.fullscreenElement ||
                document.webkitFullscreenElement) === X.wrapper &&
        ...
        const Tt = {
            ...
            initialize: function (e) {
                ...
                if (
                    ((X.wrapper = n),
                    (X.slides = n.querySelector('.slides')),
                    !X.slides)
                )
                ...
                return (
                    ...
                    (function () {
                        !0 === A.embedded
                            ? (X.viewport = r(n, '.reveal-viewport') || n)
                    ...
                    window.addEventListener('load', Be, !1),
                    ge.load(A.plugins, A.dependencies).then(fe),
            ...
            destroy: function () {
                Se(),
                    ...
                    ee.destroy(),
                    te.destroy(),
                    document.removeEventListener('fullscreenchange', Ct),
                    document.removeEventListener('webkitfullscreenchange', Ct),
                    document.removeEventListener('visibilitychange', Lt, !1),
                    window.removeEventListener('message', St, !1),
                    window.removeEventListener('load', Be, !1),
                    ...
                    Array.from(X.wrapper.querySelectorAll(m)).forEach((e) => {
            ...
            startEmbeddedContent: () => Z.startEmbeddedContent(p),
            stopEmbeddedContent: () =>
                Z.stopEmbeddedContent(p, { unloadIframes: !1 }),
            showPreview: Ne,
            hidePreview: Ie,
            ...
            getProgress: function () {
                ...
                if (p) {
                    ...
                    if (e.length > 0) {
                        let i = 0.9
                        t +=
                            (p.querySelectorAll('.fragment.visible').length /
                                e.length) *
                            i
                    }
                }
            ...
            hasNavigatedHorizontally: () => D.hasNavigatedHorizontally,
            hasNavigatedVertically: () => D.hasNavigatedVertically,
            ...
            setCurrentScrollPage: function (e, t, i) {
                ...
                ;(g = p),
                    (p = e),
                    p && g && A.autoAnimate && Ye(g, p, s, h) && ie.run(g, p),
                    a &&
                        (g &&
                            (Z.stopEmbeddedContent(g),
                            Z.stopEmbeddedContent(g.slideBackgroundElement)),
                        Z.startEmbeddedContent(p),
                        Z.startEmbeddedContent(p.slideBackgroundElement)),
                    requestAnimationFrame(() => {
                        ye(be(p))
                    }),
                    Ce()
