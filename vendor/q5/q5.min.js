function Q5(e) {
    return new (function e(t) {
        ...
        Object.defineProperty(n, 'deviceOrientation', {
            ...
            (n.createGraphics = n.createImage =
                function (t, n) {
                ...
                ;(a.set = function (e, t, n) {
                    ...
                    (a.random2D = function () {
                        return (
                            (r = 1),
                            (i = 1),
                            a.fromAngle(Math.random() * Math.PI * 2)
                        )
                    }),
                    (a.random3D = function () {
                        return (
        ...
        ;(n.createVector = function (e, t, o) {
            ...
            (n.lightness = function (e) {
                return (
                    (100 * (0.2126 * e._r + 0.7152 * e._g + 0.0722 * e._b)) /
                    255
                )
            }),
            ...
            (n.rect = function (e, t, o, a, r, i, l, u) {
                n._rectMode == n.CENTER
                    ...
                    : n._rectMode == n.RADIUS
                      ...
                      : n._rectMode == n.CORNER
                        ? _(e, t, o, a, r, i, l, u)
                        : n._rectMode == n.CORNERS &&
                          _(e, t, o - e, a - t, r, i, l, u)
            }),
            ...
            (n.curveVertex = function (e, t) {
                ...
                let a = (function (e, t, n, o, a, r, i, l, u, s) {
                    function c(e, t, n, o, a, r) {
                        let i = Math.pow(o - t, 2) + Math.pow(a - n, 2)
                        return Math.pow(i, 0.5 * r) + e
                    }
                    let h = [],
                        f = c(0, e, t, n, o, s),
                        d = c(f, n, o, a, r, s),
                ...
                for (let e = 0; e < a.length; e++)
                    r ? o.moveTo(...a[e]) : o.lineTo(...a[e]), (r = !1)
            }),
        ...
        ;(y[n.THRESHOLD] = function (e, t) {
            ...
            (y[n.GRAY] = function (e) {
                for (let t = 0; t < e.length; t += 4) {
                    const n =
                        0.2126 * e[t] + 0.7152 * e[t + 1] + 0.0722 * e[t + 2]
                    e[t] = e[t + 1] = e[t + 2] = n
                }
            }),
            ...
            (y[n.BLUR] = function (e, t) {
                ;(t = t || 1),
                    (t = Math.floor(t * n._pixelDensity)),
                    R(),
                    d.set(e)
                let a = 2 * t + 1,
                    r = (function (e) {
                ...
                for (let n = 0; n < l; n++)
                    for (let o = 0; o < i; o++) {
                        ...
                        for (let e = 0; e < a; e++) {
                            let a =
                                4 *
                                (Math.min(Math.max(n - t + e, 0), l - 1) * i +
                                    o)
                            ;(u += d[a] * r[e]),
                                (s += d[a + 1] * r[e]),
                                (c += d[a + 2] * r[e]),
            ...
            (n.filter = function (e, t) {
                if (n.HARDWARE_FILTERS && null != o.filter)
                    if ((w(), e == n.THRESHOLD)) {
                        null == t && (t = 0.5),
                            (t = Math.max(t, 1e-5)),
                            I(
                                `saturate(0%) brightness(${Math.floor((0.5 / t) * 100)}%) contrast(1000000%)`
                            )
                        ...
                        I(
                            `blur(${Math.ceil((t * n._pixelDensity) / 1) || 1}px)`
                        )
                    else {
                        let n = o.getImageData(
                            0,
                            0,
                            o.canvas.width,
                            o.canvas.height
            ...
            (n.set = function (e, t, a) {
                if (a.MAGIC == n.MAGIC) {
                    let o = n._tint
                    return (
                        (n._tint = null), n.image(a, e, t), void (n._tint = o)
                    )
                }
                let r =
                    4 *
                    (t * n._pixelDensity * o.canvas.width + e * n._pixelDensity)
                ;(n.pixels[r] = a._r),
                    (n.pixels[r + 1] = a._g),
                    (n.pixels[r + 2] = a._b),
            ...
            (n.textAlign = function (e, t) {
                ;(o.textAlign = e),
                    t && (o.textBaseline = t == n.CENTER ? 'middle' : t)
            }),
        ...
        ;(n.noise = function (e, t, n) {
            if (((t = t || 0), (n = n || 0), null == E)) {
                E = new Array(4096)
                for (var o = 0; o < 4096; o++) E[o] = Math.random()
            }
            ...
            for (
                ...
                ;(a = A(f)),
                    ...
                    (i += a * (E[(M + 1) & 4095] - i)),
                    (l = E[(M + 16) & 4095]),
                    (i += r * ((l += a * (E[(M + 16 + 1) & 4095] - l)) - i)),
                    (l = E[4095 & (M += 256)]),
                    (l += a * (E[(M + 1) & 4095] - l)),
                    (u = E[(M + 16) & 4095]),
                    (l += r * ((u += a * (E[(M + 16 + 1) & 4095] - u)) - l)),
                    (m += (i += A(p) * (l - i)) * g),
                    (g *= S),
                    (s <<= 1),
                    (c <<= 1),
                ...
                e == n.LCG
                    ? (D = (function () {
                          ...
                          return {
                              setSeed(o) {
                                  n = t =
                                      (null == o ? Math.random() * e : o) >>> 0
                              },
                              getSeed: () => t,
                              rand: () =>
                                  (n = (1664525 * n + 1013904223) % e) / e,
                          }
                      })())
                    : e == n.SHR3 && (D = T()),
                    D.setSeed()
        ...
        var P = new (function () {
            var e,
                ...
                u = new Array(256),
                s = function () {
                    return 4294967296 * D.rand() - 2147483648
                },
                c = function () {
            ...
            ;(this.SHR3 = s),
                ...
                (this.zigset = function () {
                    ...
                    for (
                        ...
                        (c = Math.sqrt(
                            -2 * Math.log(f / c + Math.exp(-0.5 * c * c))
                        )),
        ...
        ;(P.hasInit = !1),
            (n.randomGaussian = function (e, t) {
                return (
                    P.hasInit || (P.zigset(), (P.hasInit = !0)),
                    P.RNOR() * t + e
                )
            }),
        ...
        ;(n.noLoop = function () {
            ...
            (n.canvas.ontouchend = n.canvas.ontouchcancel =
                function (e) {
                    ;(n.touches = e.touches.map(O)),
                        k() &&
                            ((n.pmouseX = n.mouseX),
            ...
            (window.ondeviceorientation = function (e) {
                ;(n.pRotationX = n.rotationX),
                    (n.pRotationY = n.rotationY),
                    (n.pRotationZ = n.rotationZ),
                    (n.pRelRotationX = n.relRotationX),
                    (n.pRelRotationY = n.relRotationY),
                    (n.pRelRotationZ = n.relRotationZ),
                    (n.rotationX = e.beta * (Math.PI / 180)),
                    (n.rotationY = e.gamma * (Math.PI / 180)),
                    (n.rotationZ = e.alpha * (Math.PI / 180)),
                    (n.relRotationX = [-n.rotationY, -n.rotationX, n.rotationY][
                        1 + ~~(window.orientation / 90)
                    ]),
                    (n.relRotationY = [-n.rotationX, n.rotationY, n.rotationX][
                        1 + ~~(window.orientation / 90)
                    ]),
                    (n.relRotationZ = n.rotationZ)
            }),
            (window.ondevicemotion = function (e) {
                if (
                    ((n.pAccelerationX = n.accelerationX),
                    (n.pAccelerationY = n.accelerationY),
                    (n.pAccelerationZ = n.accelerationZ),
                    !e.acceleration)
                ) {
                    let t = ((e, t) => [
                    ...
                    ;(n.accelerationX =
                        e.accelerationIncludingGravity.x + t[0]),
                        (n.accelerationY =
                            e.accelerationIncludingGravity.y + t[1]),
                        (n.accelerationZ =
                            e.accelerationIncludingGravity.z - t[2])
                }
            }),
            (n.year = function () {
